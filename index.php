...
<body>
  ...
  <!-- forms s-->
		...
		<div class="container">
			...
			<section class="slider">
				<div class="flexslider">
				 ...
				 <?php while($result = mysqli_fetch_assoc($test)){ ?>

						<li>
             <div class="testimonial-agileits-w3layouts">
								<p><?php echo $result['desc'] ?></p>
								<img src="images/landing/dummymale.jpg" alt=" " class="img-responsive">
								<div class="test-name">
									<h5><?php echo $result['first_name']; ?></h5>
	...
	<script src="js/landing/jquery.countup.js"></script>
	<script>
		$('.counter').countUp();
	</script>
	<!-- //stats -->
	<!-- flexSlider -->
	<script defer src="js/landing/jquery.flexslider.js"></script>
	...
	<!-- //flexSlider -->
	<!-- Responsiveslides -->
	<script src="js/landing/responsiveslides.min.js"></script>
	<script>

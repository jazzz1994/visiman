...
License: Creative common/landings Attribution 3.0 Unported
License URL: http://creativecommon/landings.org/licenses/by/3.0/
-->
<!DOCTYPE html>
<html lang="en">
...
<body>
			...
			<header>
				...
				<div class="header-bottom-w3layouts">
					<div class="main-w3ls-logo">
						<h1><a href="index.html"><span class="fa fa-check-square-o" aria-hidden="true"></span>parent panel</a></h1>
					</div>
					<!-- navigation -->
	...
	<div class="about-mid">
		...
		<div class="mid-info">
			<h3 class="subheading-wthree white-clr">Out Trainers</h3>
			<p class="paragraph-agileinfo white-clr">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sed odio consequat, tristique elit sed, molestie nulla.</p>
			<ul>
				<li><span class="fa fa-asterisk" aria-hidden="true"></span>consectetur adipiscing elit.</li>
				<li><span class="fa fa-asterisk" aria-hidden="true"></span>Lorem ipsum dolor sit amet</li>
		...
		<div class="container">
			...
			<div class="col-md-6 team-right">
				<div class="col-md-6 col-sm-6 col-xs-6 team-grid">
					<img class="team-img img-responsive" src="images/landing/t1.jpg" alt="">
					<h6>Andrew Bert</h6>
				...
				<div class="col-md-6 col-sm-6 col-xs-6 team-grid t2">
					<img class="team-img img-responsive" src="images/landing/t2.jpg" alt="">
					<h6>Mecan smith</h6>
					<div class="social-icons-agileits">
						<ul>
							<li><a href="#"><span class="fa fa-facebook"></span></a></li>
				...
				<div class="col-md-6 col-sm-6 col-xs-6 team-grid">
					<img class="team-img img-responsive" src="images/landing/t4.jpg" alt="">
					<h6>Jack Bravo</h6>
					<div class="social-icons-agileits">
						<ul>
							<li><a href="#"><span class="fa fa-facebook"></span></a></li>
				...
				<div class="col-md-6 col-sm-6 col-xs-6 team-grid">
					<img class="team-img img-responsive" src="images/landing/t3.jpg" alt="">
					<h6>Bernard Smith</h6>
					<div class="social-icons-agileits">
						<ul>
							<li><a href="#"><span class="fa fa-facebook"></span></a></li>
	...
	<div class="footer-agileits-w3layouts">
		<div class="container">
			<div class="btm-logo-w3ls">
				<h2><a href="index.html"><span class="fa fa-check-square-o" aria-hidden="true"></span>Parent Panel</a></h2>
			</div>
